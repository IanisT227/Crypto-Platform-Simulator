package org.ianis_teja.crypto_platform_simulator.app.theme
...
@Immutable
data class CryptoPlatformColors(
...
val LightCryptoPlatformColorsPalette = CryptoPlatformColors(
    profitGreen = ProfitGreenColor,
    lossRed = LossRedColor,
)

val DarkCryptoPlatformColorsPalette = CryptoPlatformColors(
    profitGreen = DarkProfitGreenColor,
    lossRed = DarkLossRedColor,
)

val LocalCryptoPlatformColorsPalette = compositionLocalOf { CryptoPlatformColors() }